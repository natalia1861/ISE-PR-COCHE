...
/************Flags comunes a todos los estados*************************************************/
        ...
        if (flags & FLAG__ERROR) //Flag de error
        {
            ...
            LCD_write(LCD_LINE__TWO, detalleError); //revisarNAK a�adir detalle de error
        }
            ...
            switch (app_state)
            {
                ...
                case APP_STAGE__BACK_GEAR:
                    ...
                    {   
                        ...
                        //Creamos el hilo de solicitud de distancia cada x tiempo que mandar� comando de solicitud de distancia revisarNAK revisarMSP
                        Init_askDistanceControl();
                        
                        state_enter = false;
                    }
                    
                    osDelay (1000); //Espera 2 segundos para visualizar que se entr� al estado de marcha atr�s
                ...
                case APP_STAGE__MOSTRAR_CONSUMO:
                    if (state_enter)
                    {
                        ...
                        //Mostramos en la l�nea 1 del LCD que estamos en el modo de mostrar consumo
